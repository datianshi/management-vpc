...
'bash -es' <<ENDSSH
  ...
  TEAM_USERNAME=${TEAM_USERNAME} TEAM_PASSWORD=${TEAM_PASSWORD}   AWS_ACCESS_KEY=${AWS_ACCESS_KEY} AWS_SECRET_KEY=${AWS_SECRET_KEY} OPSMAN_PASSWORD=${OPSMAN_PASSWORD} ./concourse/prepare_team.sh
  exit
ENDSSH
